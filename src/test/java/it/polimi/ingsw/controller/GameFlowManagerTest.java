...
class GameFlowManagerTest {
  ...
  void gameFlowTest() {
    ...
    assertEquals(
        ...
        gameModelUpdater
            .getPlayers()
            .draw(gameFlowManager.idToToken.draw(firstPlayer))
            .getBoard()
    ...
    assertNull(
        gameModelUpdater
            .getPlayers()
            .draw(gameFlowManager.idToToken.draw(secondPlayer))
            .getBoard()
            .getCard(new Coords(1, 1)));
    ...
    gameFlowManager.gameModelUpdater.setScoreTrack(
        Arrays.asList(
            gameFlowManager.idToToken.draw(firstPlayer),
            gameFlowManager.idToToken.draw(secondPlayer)));
    gameFlowManager
        .gameModelUpdater
        .getModel()
        .getScoreTrack()
        .updatePlayerScore(gameFlowManager.idToToken.draw(firstPlayer), 23);
