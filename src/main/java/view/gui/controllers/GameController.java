...
public class GameController extends Controller {
    ...
    @FXML public HBox leftButtonsHBox;
    @FXML public Button rightPanelButton;
    @FXML public Button objectivesButton;
    @FXML public Button decksButton;
    ...
    public void handleOnMouseClickedLeftPanelButton(MouseEvent event) {
        leftPanelButton.setText(leftPanelButton.getText().equals("Close") ? "Open" : "Close");

        leftButtonsHBox.setVisible(!leftButtonsHBox.isVisible());
        leftButtonsHBox.setMouseTransparent(!leftButtonsHBox.isMouseTransparent());
    ...
    public void handleOnMouseClickedRightPanelButton(MouseEvent event) {
        rightPanelButton.setText(rightPanelButton.getText().equals("Close") ? "Open" : "Close");
    ...
    public void handleOnMouseClickedDecksButton(MouseEvent event) {
        leftTabPane.getSelectionModel().select(1);
        objectivesButton.setOpacity(0.5);
        decksButton.setOpacity(1);

        event.consume();
    }

    public void handleOnMouseClickedObjectivesButton(MouseEvent event) {
        leftTabPane.getSelectionModel().select(0);
        objectivesButton.setOpacity(1);
        decksButton.setOpacity(0.5);
