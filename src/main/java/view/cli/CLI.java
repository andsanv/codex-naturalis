...
import view.cli.scene.scenes.AccountScene;
import view.cli.scene.scenes.ConnectionLostScene;
import view.cli.scene.scenes.ConnectionScene;
import view.cli.scene.scenes.EndingGameInitScene;
import view.cli.scene.scenes.GameScene;
import view.cli.scene.scenes.HomeScene;
import view.cli.scene.scenes.LastPlayerScene;
import view.cli.scene.scenes.LastPlayerWonScene;
import view.cli.scene.scenes.LobbiesScene;
import view.cli.scene.scenes.ObjectiveCardScene;
import view.cli.scene.scenes.ResultsScene;
import view.cli.scene.scenes.StarterCardScene;
import view.cli.scene.scenes.TokenSelectionScene;
import view.cli.scene.scenes.UserInfoLoginScene;
