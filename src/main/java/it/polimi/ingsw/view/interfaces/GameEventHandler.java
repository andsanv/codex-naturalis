...
public interface GameEventHandler {
        ...
        /**
         * Handles the event of a player turn starting.
         * 
         * @param currentPlayer the player token of the player who plays
         */
        public void handlePlayerTurnEvent(PlayerToken currentPlayer);

        /**
         * Handles the declaration of the last round.
         */
        public void handleLastRoundEvent();

        /**
         * Handles beign the last player connected and the start of the timer.
         */
        public void handleLastConnectedPlayerEvent();

        /**
         * Handles the winning condition of being the last player connected to the match
