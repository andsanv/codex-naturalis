...
/**
 * Contains an user's information (name and unique id). The class is meant to be used on the server.
 * Synchronization on the class is implemented to ensure that all ids are unique.
 */
