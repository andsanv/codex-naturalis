...
public class InitializationState extends GameState {
  ...
  public boolean handleInitialization(
    ...
    GameModelUpdater gameModelUpdater = new GameModelUpdater(
        new GameModel(decks, playerTokens, tokenToStarterCard, tokenToCardSide, tokenToObjectiveCard, commonObjectives,
    ...
    try {
      ...
      ServerPrinter.displayError("GameFlowManager thread was interrupted."); // allows clients to fetch data from slim
                                                                             // model
    }
    return true;
  }
