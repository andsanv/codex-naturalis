...
public final class DrawnVisibleResourceCardEvent extends GameEvent {
   ...
   * @param drawnCardPosition the drawn card position in the visibile resource cards
   * @param drawnCardId the id of the drawn card
   */
  public DrawnVisibleResourceCardEvent(
  ...
  public void execute(GameEventHandler gameUpdateHandler) {
    gameUpdateHandler.handleDrawnVisibleResourceCardEvent(
        playerToken, drawnCardPosition, drawnCardId);
  }
}
